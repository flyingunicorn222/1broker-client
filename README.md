...
====
  ...
  - Nick ( @Bitpie ) from 1Broker for the support on the [1Broker Trollbox](https://t.me/Trollbox_1Broker)

  - 1Broker for the awesome platform, fingers crossed for even more success!

disclaimer
====
 - Altough this isn't an official [1Broker](https://1broker.com/?r=11468) client, they provided great support and cleared all questions, very kind and great support!
...
when you create an order! Please keep it this way so i can keep working on improving and keeping the code up to date, thanks to [1Broker](https://1broker.com/?r=11468) for such a deal,
without this i wouldn't be able to order late night pizzas.

 - [1broker](https://1broker.com/?r=11468) links on this documentation constains my referral link, in case you still don't have an account please use the links provided.
